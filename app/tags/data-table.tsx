...
import { TagAttributes, TagData, TagStatus } from '@/types/tags'
...
export function DataTable({ columns }: DataTableProps) {
  ...
  const {
    ...
    isValidating,
    mutate,
  } = useSWR([pagination.pageIndex, globalFilter, filterStatus], () => {
    ...
    <div className="w-full p-6 flex flex-col gap-4 lg:max-w-4xl lg:mx-auto">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuCheckboxItem
                ...
                onCheckedChange={setShowUpdatedAt}
              >
                Atualizado em
              </DropdownMenuCheckboxItem>
            </DropdownMenuContent>
        ...
        <ConfirmDialog
          ...
          deactivateDescription={
            <>
              Ao desativar{' '}
              <b>
                {selectedTag?.attributes.name}, não ficará visível na listagem
                de pacientes
              </b>
              , mas continuará disponível em <b>relatórios</b>. Você poderá{' '}
              <b>reativar</b> depois.
            </>
          }
          activateDescription={
            <>
              Ao reativar <b>{selectedTag?.attributes.name}</b>, você poderá
              vê-lo novamente na <b>listagem de pacientes</b> e permanece
              disponível nos <b>relatórios</b>.
            </>
          }
        />
      </div>
      ...
      <div className="flex flex-col gap-4 items-center md:flex-row md:justify-between md:items-center">
        <small className="text-muted-foreground md:flex-1">
          Total de Tags: {meta?.total_count}
        </small>
